...
export const ENEMIES: Record<string, Omit<Enemy, "id" | "maxHp" | "phase2">> = {
  ...
  river_kappa: {
    ...
    gold: 40,
    ai: "balanced",
    skills: ["basic_attack", "water_splash"],
    drops: [{ id: "chakra_pill", rate: 0.35 }],
  },
  shadow_wolf: {
    name: "影狼",
    icon: "🐺",
    ...
    gold: 55,
    ai: "speed",
    skills: ["swift_bite", "howl"],
    drops: [{ id: "heal_scroll", rate: 0.25 }],
  },
  stone_golem: {
    name: "岩石傀儡",
    icon: "🗿",
    ...
    gold: 90,
    ai: "tank",
    skills: ["heavy_slam", "stone_skin"],
    drops: [{ id: "heal_scroll_large", rate: 0.15 }],
  },
};
...
export const QUESTS: Quest[] = [
  ...
  },
  {
    ...
    rank: "D",
    area: "river",
    desc: "川を渡る旅人を脅かす河童を2体退治せよ。水辺には近づきすぎるな。",
    type: "kill",
    target: "river_kappa",
    count: 2,
    reward: { exp: 120, gold: 90, items: [{ id: "chakra_pill", count: 1 }] },
    minLevel: 2,
  },
  {
    id: "q007",
    ...
    rank: "B",
    area: "river",
    desc: "河川上流に現れた岩石の傀儡が水路を塞いでいる。破壊して水の流れを取り戻せ。",
    type: "kill",
    target: "stone_golem",
    count: 1,
    reward: { exp: 700, gold: 400, items: [{ id: "heal_scroll_large", count: 1 }] },
    minLevel: 6,
  },
];
...
export const AREAS: Record<string, { name: string; desc: string; minLevel: number; quests: string[]; icon: string }> = {
  ...
  river: {
    name: "霊流の大河",
    desc: "チャクラを帯びた不思議な大河。妖怪や魔物が多く生息する。",
    minLevel: 2,
    quests: ["q006", "q007"],
    icon: "🌊",
  },
