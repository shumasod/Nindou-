...
export const SKILLS: Record<string, Skill> = {
  ...
  mirage_veil: {
    ...
    cost: 20,
    type: "buff",
    desc: "2ターン間、防御力と回避率を同時に上昇させる",
    effect: { stat: "defense", mult: 1.3, turns: 2 },
    clan: "illusion",
  },
  shinigami_illusion: {
    name: "死神の幻",
  ...
  wind_slash: {
    ...
    cost: 18,
    type: "damage",
    desc: "風の如き速さで斬りつける。攻撃力の2.8倍ダメージ",
    multiplier: 2.8,
    clan: "speed",
  },
  shadow_clone: {
...
export const SKILL_UNLOCK: Record<string, { level: number; clan: string }> = {
  ...
  blood_surge:         { level: 5,  clan: "force" },
  mirage_veil:         { level: 5,  clan: "illusion" },
  wind_slash:          { level: 5,  clan: "speed" },
